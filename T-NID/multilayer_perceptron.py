...
class MLP(nn.Module):
    ...
    def create_main_effect_nets(self, num_features, hidden_units, out_bias, name, activation, use_last_gelu=False):
        mlp_list = [
...
def create_mlp(layer_sizes, activation=nn.GELU, out_bias=True, dropout_p=0, use_final_gelu=False, use_last_gelu=False, use_alt_gelu=False):
    ls = list(layer_sizes)
